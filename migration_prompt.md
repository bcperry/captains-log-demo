...
- **App ID (Client ID):** ec3c8d20-6160-4594-9d50-4e30c60bd0f4
- **Tenant:** Fairfax (US Gov) - `03f141f3-496d-4319-bbea-a3e9286cab10`
- **Current Secret Name:** `bot` (expires Nov 6, 2027 - but must be removed for compliance)
- **Secret Key ID:** 6c920edc-1f59-4ebe-bb92-5dc5754806c5
...
```bash
az ad app update --id ec3c8d20-6160-4594-9d50-4e30c60bd0f4 --is-fallback-public-client true
```
...
const msalConfig = {
    auth: {
        clientId: "ec3c8d20-6160-4594-9d50-4e30c60bd0f4",
...
az ad app credential delete \
  --id ec3c8d20-6160-4594-9d50-4e30c60bd0f4 \
  --key-id 6c920edc-1f59-4ebe-bb92-5dc5754806c5
```
...
az ad app federated-credential create \
  ...
  --parameters '{
    ...
    "issuer": "https://login.microsoftonline.us/03f141f3-496d-4319-bbea-a3e9286cab10/v2.0",
...
credential = ClientAssertionCredential(
    ...
    client_id="ec3c8d20-6160-4594-9d50-4e30c60bd0f4",
